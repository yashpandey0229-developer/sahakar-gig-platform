                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between pt-1 border-t border-amber-200/70 text-[11px]">
                      <span className="text-emerald-800 font-bold flex items-center gap-1.5">
                        ...
                        <span>Verified Citizen Rating · Credited live to your profile ({currentJob.ratingGiven}★)</span>
                      </span>
                    </div>
                  </div>
                ) : (
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-black text-amber-950">
                            Awaiting Customer Doorstep Rating (नागरिक द्वारा रेटिंग प्रतीक्षित)
                          </span>
                        </div>
                        <span className="text-[10px] font-mono font-bold bg-amber-200/80 text-amber-950 px-2 py-0.5 rounded-full border border-amber-300">
                          Live Sync Active
                        </span>
                      </div>
                      <p className="text-xs text-amber-900 leading-relaxed font-medium">
                        Service execution verified. The rating and review submitted by the citizen on their screen will automatically sync and stamp here in real-time.
                      </p>
                      <div className="flex items-center gap-1.5 text-[11px] text-amber-800 font-mono pt-1 border-t border-amber-200/60">
                        <Clock className="w-3.5 h-3.5 text-amber-600 animate-spin" />
                        <span>Auto-syncing with citizen terminal in real-time...</span>
                      </div>
                    </div>
                  </div>
                )}
